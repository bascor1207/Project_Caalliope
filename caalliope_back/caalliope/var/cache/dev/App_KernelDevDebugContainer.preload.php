...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerXnhVMWU\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerXnhVMWU/EntityManager_9a5be93.php';
require __DIR__.'/ContainerXnhVMWU/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerXnhVMWU/getValidator_ExpressionService.php';
require __DIR__.'/ContainerXnhVMWU/getValidator_EmailService.php';
require __DIR__.'/ContainerXnhVMWU/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerXnhVMWU/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerXnhVMWU/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerXnhVMWU/getSession_FactoryService.php';
require __DIR__.'/ContainerXnhVMWU/getServicesResetterService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerXnhVMWU/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerXnhVMWU/getSecrets_VaultService.php';
require __DIR__.'/ContainerXnhVMWU/getRouting_LoaderService.php';
require __DIR__.'/ContainerXnhVMWU/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerXnhVMWU/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerXnhVMWU/getErrorControllerService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerXnhVMWU/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerXnhVMWU/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerXnhVMWU/getContainer_GetenvService.php';
require __DIR__.'/ContainerXnhVMWU/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerXnhVMWU/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_SystemClearerService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_SystemService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_AppClearerService.php';
require __DIR__.'/ContainerXnhVMWU/getCache_AppService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerXnhVMWU/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerXnhVMWU/getTemplateControllerService.php';
require __DIR__.'/ContainerXnhVMWU/getRedirectControllerService.php';
require __DIR__.'/ContainerXnhVMWU/getUsersRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getStatusRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getSagaRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getPublierRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getGenreRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getFormatRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getEditerRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getBooksRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getBookRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/getAuthorsRepositoryService.php';
require __DIR__.'/ContainerXnhVMWU/get_ServiceLocator_XUrKPVUService.php';
require __DIR__.'/ContainerXnhVMWU/get_ServiceLocator_O3sqUs1Service.php';
require __DIR__.'/ContainerXnhVMWU/get_ServiceLocator_BRdave9Service.php';
require __DIR__.'/ContainerXnhVMWU/get_Container_Private_TwigService.php';
require __DIR__.'/ContainerXnhVMWU/get_Container_Private_SessionService.php';
require __DIR__.'/ContainerXnhVMWU/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerXnhVMWU/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerXnhVMWU/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Repository\EditerRepository';
$classes[] = 'App\Repository\FormatRepository';
$classes[] = 'App\Repository\GenreRepository';
$classes[] = 'App\Repository\PublierRepository';
$classes[] = 'App\Repository\SagaRepository';
