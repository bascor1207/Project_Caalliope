 ...
 */
class getSagaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SagaRepository' shared autowired service.
     *
     * @return \App\Repository\SagaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SagaRepository.php';

        return $container->privates['App\\Repository\\SagaRepository'] = new \App\Repository\SagaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
