 ...
 */
class getPublierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PublierRepository' shared autowired service.
     *
     * @return \App\Repository\PublierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PublierRepository.php';

        return $container->privates['App\\Repository\\PublierRepository'] = new \App\Repository\PublierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
