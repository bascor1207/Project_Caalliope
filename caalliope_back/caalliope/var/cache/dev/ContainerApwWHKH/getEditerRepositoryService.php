 ...
 */
class getEditerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EditerRepository' shared autowired service.
     *
     * @return \App\Repository\EditerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EditerRepository.php';

        return $container->privates['App\\Repository\\EditerRepository'] = new \App\Repository\EditerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
